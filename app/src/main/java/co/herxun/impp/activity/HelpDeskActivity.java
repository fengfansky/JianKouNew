...
public class HelpDeskActivity extends BaseActivity {
	...
	private void initView(){
		...
		findViewById(R.id.helpdesk_btn_customservice_base).setOnClickListener(new OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent i = new Intent(HelpDeskActivity.this,CustomServiceBaseActivity.class);
                startActivity(i);
                overridePendingTransition(R.anim.slide_in_right,android.R.anim.fade_out);
            }
        });
		
		findViewById(R.id.helpdesk_btn_customservice_pro).setOnClickListener(new OnClickListener(){
			@Override
			public void onClick(View v) {
