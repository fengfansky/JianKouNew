...
public class CustomServiceBaseActivity extends Activity {
    ...
    private void initView() {
        ...
        appbar.getTextView().setText(R.string.cs_vip_base);

        listView = (ListView) findViewById(R.id.cs_listView);
        listView.setOnItemClickListener(new OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Chat chat = IMManager.getInstance(CustomServiceBaseActivity.this).addChat(adapter.getItem(position).clientId);
                IMManager.getInstance(CustomServiceBaseActivity.this).notifyChatUpdated();
                Intent i = new Intent(CustomServiceBaseActivity.this, ChatActivity.class);
                Bundle b = new Bundle();
                        ...
                        public void onSuccess(JSONObject response) {
                            ...
                            try {
                                ...
                                for (int i = 0; i < csunits.length(); i++) {
                                    ...
                                    user.userId = "";
                                    user.userName = name;
                                    UserManager.getInstance(CustomServiceBaseActivity.this).saveUser(user);
                                }
    ...
    public class MemberListAdapter extends BaseAdapter {
        ...
        private class CSUnitListItem extends UserListItem {
            ...
            public CSUnitListItem(Context ct) {
                ...
                LayoutParams rlpTextFS = new LayoutParams(-2, Utils.px2Dp(ct, 36));
