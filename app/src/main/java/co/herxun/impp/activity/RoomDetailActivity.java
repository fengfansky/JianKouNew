        ...
        if (room.usersIds.indexOf(me.userId) != -1) {
            ...
            joinBtn.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    IMManager.getInstance(RoomDetailActivity.this).removeTopicMembers(me.clientId, t,
        ...
        roomManager.setOnLikeListener(new LikeCallback() {
            ...
            public void onSuccess(Post post) {
                try {
                    ...
                    // cData.put(Constant.FRIEND_REQUEST_KEY_TYPE,
                    // Message.TYPE_LIKE);
                    cData.put("notification_alert",
                            UserManager.getInstance(RoomDetailActivity.this).getCurrentUser().userName
                                    + R.string.room_to + room.name + R.string.room_like);
