...
public class IMppApp extends Application {
    ...
    private void init() {
        ...
        try {
            ...
            anSocial.setSecureConnection(false);
//            anSocial.setHost("192.168.0.15:3000");
//            anSocial.setAPISecret("mOXChfZR3fhp2pVfcNlbRSruSv7yaFT8");
            anPush = AnPush.getInstance(this);
//            anPush.setHosts("192.168.0.15:3002", "192.168.0.15:9999");
