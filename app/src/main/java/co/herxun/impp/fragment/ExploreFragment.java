...
public class ExploreFragment extends BaseFragment {
    ...
    private void initView(View fragView, final Context ct) {
        ...
        fragView.findViewById(R.id.explore_btn_annon).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getActivity(), AnnounceListActivity.class);
                startActivity(i);
                getActivity().overridePendingTransition(R.anim.slide_in_right, android.R.anim.fade_out);
            }
        });
        
        applyButton = (TextView) fragView.findViewById(R.id.apply_btn);
        applyButton.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(ct, ApplySourceCodeActivity.class);
