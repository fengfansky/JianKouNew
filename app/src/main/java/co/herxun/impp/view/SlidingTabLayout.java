...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    /**
     * Set the {@link OnPageChangeListener}. When using {@link SlidingTabLayout} you are
     * required to set any {@link OnPageChangeListener} through this method. This is so
     * that the layout can update it's scroll position correctly.
     *
     * @see ViewPager#setOnPageChangeListener(OnPageChangeListener)
     */
    ...
    private class CustomTabView extends RelativeLayout{
		...
		public CustomTabView(Context context) {
			...
			LayoutParams rlpTextView = new LayoutParams(-2,-2);
			rlpTextView.addRule(RelativeLayout.CENTER_IN_PARENT);
			addView(textView,rlpTextView);
			
			LayoutParams rlpBadgeView = new LayoutParams(-2,(int) (21 * scale + 0.5f));
